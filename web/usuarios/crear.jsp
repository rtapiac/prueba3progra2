                    ...
                    <div class="panel-body">
                        <form method="POST" action="../ServletUsuario">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre_usuario" id="nombre" placeholder="Ingresar Nombre">
                            </div>
                            <div class="form-group">
                                <label for="nombre">Contraseña</label>
                                <input type="text" class="form-control" name="clave" id="nombre" placeholder="Ingresar Contraseña">
                            </div>
                            <div class="form-group">
